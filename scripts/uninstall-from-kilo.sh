#!/usr/bin/env bash
# =============================================================================
# uninstall-from-kilo.sh - Remove Overpowers from Kilo Code
# =============================================================================
# Reverses all changes made by deploy-to-kilo.sh
# =============================================================================
...
PLATFORM_DIR="${HOME}/.kilocode"
BACKUP_PLATFORM="kilo"

# Symlinks created by deploy-to-kilo.sh
declare -A SYMLINKS=(
    ["agents"]="skills"
    ["skills"]="workflows"
    ["hooks"]="rules"
