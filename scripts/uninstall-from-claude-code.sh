#!/usr/bin/env bash
# =============================================================================
# uninstall-from-claude-code.sh - Remove Overpowers from Claude Code
# =============================================================================
# Reverses all changes made by deploy-to-claude-code.sh
# =============================================================================
...
BACKUP_PLATFORM="claude-code"

# Symlinks created by deploy-to-claude-code.sh
declare -A SYMLINKS=(
    ["skills"]="skills"
    ["commands"]="commands"
    ["AGENTS.md"]="CLAUDE.md"
