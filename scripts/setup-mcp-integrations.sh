...
install_mcp() {
    ...
    case "$mcp_name" in
        ...
        "pagespeed-insights")
            ...
            print_info "Use: ./.agent/skills/pagespeed-integration/scripts/pagespeed-helper.sh for CLI access"
            ;;
        "grep-vercel")
        ...
        "stagehand")
            ...
            if ! bash "${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-helper.sh" status &> /dev/null; then
                print_info "Installing Stagehand JavaScript first..."
                bash "${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-helper.sh" install
            fi
            ...
            print_info "Use: ./.agent/skills/stagehand-integration/scripts/stagehand-helper.sh for CLI access"
            ;;
        "stagehand-python")
            print_info "Setting up Stagehand Python AI Browser Automation MCP integration..."

            # First ensure Stagehand Python is installed
            if ! bash "${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh" status &> /dev/null; then
                print_info "Installing Stagehand Python first..."
                bash "${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh" install
            fi
            ...
            print_info "Use: ./.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh for CLI access"
            ;;
        "stagehand-both")
            ...
            print_info "JavaScript: ./.agent/skills/stagehand-integration/scripts/stagehand-helper.sh"
            print_info "Python: ./.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh"
            ;;
        *)
            print_error "Unknown MCP integration: $mcp_name"
