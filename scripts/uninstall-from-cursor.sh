#!/usr/bin/env bash
# =============================================================================
# uninstall-from-cursor.sh - Remove Overpowers from Cursor
# =============================================================================
# Reverses all changes made by deploy-to-cursor.sh
# Note: Cursor stores extensions separately
# =============================================================================
...
PLATFORM_DIR="${HOME}/.cursor"
BACKUP_PLATFORM="cursor"

# Symlinks created by deploy-to-cursor.sh
declare -A SYMLINKS=(
    ["skills"]="skills"
)
