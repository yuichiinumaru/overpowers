#!/usr/bin/env bash
# =============================================================================
# uninstall-from-windsurf.sh - Remove Overpowers from Windsurf
# =============================================================================
# Reverses all changes made by deploy-to-windsurf.sh
# Follows Windsurf convention from research
# =============================================================================
...
PLATFORM_DIR="${HOME}/.codeium/windsurf"
BACKUP_PLATFORM="windsurf"

# Symlinks created by deploy-to-windsurf.sh
declare -A SYMLINKS=(
    ["skills"]="skills"
)
