...
install_selected_linters() {
    ...
    print_info "- Auto-fix issues: bash .agent/skills/codacy-integration/scripts/codacy-cli.sh analyze --fix"
    print_info "- Universal formatting: bash .agent/skills/qlty-integration/scripts/qlty-cli.sh fmt --all"
