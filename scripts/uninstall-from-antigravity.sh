#!/usr/bin/env bash
# =============================================================================
# uninstall-from-antigravity.sh - Remove Overpowers from Antigravity
# =============================================================================
# Reverses all changes made by deploy-to-antigravity.sh
# =============================================================================
...
PLATFORM_DIR="${HOME}/.gemini/antigravity"
BACKUP_PLATFORM="antigravity"

# Symlinks created by deploy-to-antigravity.sh
declare -A SYMLINKS=(
    ["skills"]="skills"
