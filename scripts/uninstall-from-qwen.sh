#!/usr/bin/env bash
# =============================================================================
# uninstall-from-qwen.sh - Remove Overpowers from Qwen Code
# =============================================================================
# Reverses all changes made by deploy-to-qwen.sh
# Qwen Code uses npx primarily
# =============================================================================
...
# --- Configuration ---
PLATFORM_NAME="Qwen Code"
PLATFORM_DIR="${HOME}/.qwen"
BACKUP_PLATFORM="qwen"

# Symlinks created by deploy-to-qwen.sh
declare -A SYMLINKS=(
    ["skills"]="skills"
    ["AGENTS.md"]="AGENTS.md"
)
