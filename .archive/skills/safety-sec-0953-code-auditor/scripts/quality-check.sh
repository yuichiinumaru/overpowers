...
check_secrets() {
    ...
    local secretlint_script=".agent/skills/sast-configuration/scripts/secretlint-helper.sh"
    local violations=0
...
check_quality_clis() {
    ...
    # CodeRabbit CLI
    local coderabbit_script=".agent/skills/code-auditor/scripts/coderabbit-cli.sh"
    ...
    # Codacy CLI
    local codacy_script=".agent/skills/code-auditor/scripts/codacy-cli.sh"
    ...
    # SonarScanner CLI
    local sonar_script=".agent/skills/sast-configuration/scripts/sonarscanner-cli.sh"
...
main() {
    ...
    print_info "Run: bash .agent/skills/obsidian-markdown/scripts/markdown-lint-fix.sh manual . (for quick fixes)"
    print_info "Run: bash .agent/skills/obsidian-markdown/scripts/markdown-formatter.sh format . (for comprehensive formatting)"
    echo ""
