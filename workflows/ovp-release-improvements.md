...
- **Version Manager**: `.agent/skills/coding/review/github-release-management/scripts/version-manager.sh release [major|minor|patch]`
- **Validator**: `.agent/skills/coding/review/github-release-management/scripts/validate-version-consistency.sh [version]`
...
- **Standalone validator**: `.agent/skills/coding/review/github-release-management/scripts/validate-version-consistency.sh`
...
- `.agent/skills/coding/review/github-release-management/scripts/version-manager.sh` - Enhanced validation and README badge updates
- `.agent/skills/coding/review/github-release-management/scripts/auto-version-bump.sh` - Fixed regex pattern for macOS compatibility

### New Scripts Created

- `.agent/skills/coding/review/github-release-management/scripts/validate-version-consistency.sh` - Standalone version validator
...
./.agent/skills/coding/review/github-release-management/scripts/version-manager.sh release patch
