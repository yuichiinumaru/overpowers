...
```bash
# Codacy auto-fix
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/codacy-cli.sh analyze --fix

# Qlty auto-format
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/qlty-cli.sh fmt --all
