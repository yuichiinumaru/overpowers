...
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/quality-check.sh

# Use CodeRabbit for AI-powered review
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/coderabbit-cli.sh review

# Use Codacy for analysis
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/codacy-cli.sh analyze

# Use Qlty for universal checking
bash ~/Git/aidevops/.agent/skills/coding/review/code-auditor/scripts/qlty-cli.sh check
```
