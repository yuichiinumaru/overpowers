...
./skills/coding/review/sast-configuration/scripts/snyk-helper.sh

# SonarCloud code analysis
./skills/coding/review/sast-configuration/scripts/sonarcloud-cli.sh analyze

# Secret detection
./skills/coding/review/sast-configuration/scripts/secretlint-helper.sh
```
