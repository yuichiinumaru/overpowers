...
./skills/sast-configuration/scripts/snyk-helper.sh

# SonarCloud code analysis
./skills/sast-configuration/scripts/sonarcloud-cli.sh analyze

# Secret detection
./skills/sast-configuration/scripts/secretlint-helper.sh
```
