...
You are performing a comprehensive security audit using the Z-Audit skill at `/home/sephiroth/.config/opencode/Overpowers/skills/security/auditing/z-audit/SKILL.md`.
