...
- ❌ Bad: `See skills/coding/testing/testing` (unclear if required)
- ❌ Bad: `@skills/coding/testing/testing/SKILL.md` (force-loads, burns context)
...
See [graphviz-conventions.dot](https://github.com/yuichiinumaru/overpowers/blob/main/skills/content/documentation/writing-skills/graphviz-conventions.dot) for graphviz style rules.
