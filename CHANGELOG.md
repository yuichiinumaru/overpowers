...
## [2026-02-05] - Forensic JSON Recovery

### Fixed
- **Agents**: Recovered corrupted `agents-all.json` file (~275KB, 2298 lines).
- **Core**: Surgically corrected 423 agent blocks, resolving 'Extra Data' and 'Unbalanced Braces' errors.
- **Cleanup**: Institutionalized forensic artifacts to `docs/00-archive/json-recovery/`.
