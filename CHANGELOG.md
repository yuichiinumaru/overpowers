...
### Added
- **Skills**: `voice-call`, `telegram`, `whatsapp` (ported from Moltbot extensions).
- **Documentation**:
  - `docs/future/advanced-hooks.md`: Blueprint for `todo-continuation` and `edit-recovery`.
  - `docs/future/mcp-integrations.md`: Configs for `grep-app` and `context7`.

### Changed
- **Agents**: Re-generated agent configs to include new advisor/researcher capabilities.
