...
const MODEL_NAME_TO_ENUM: Record<string, ModelEnumValue> = {
  ...
  'claude-4-5-sonnet': ModelEnum.CLAUDE_3_5_SONNET_20241022,
  'claude-4-5-sonnet-thinking': ModelEnum.CLAUDE_3_5_SONNET_20241022,
  'claude-3.5-haiku': ModelEnum.CLAUDE_3_5_HAIKU_20241022,
  'claude-4-5-haiku': ModelEnum.CLAUDE_3_5_HAIKU_20241022,
  'claude-4-5-haiku-20241022': ModelEnum.CLAUDE_3_5_HAIKU_20241022,
