...
```json
{
  "requesting_agent": "tooling_engineer",
...
- Collaborate with dx_optimizer on workflows
- Support cli_developer on CLI patterns
- Work with build_engineer on build tools
- Guide documentation_engineer on docs
- Help devops_engineer on automation
- Assist refactoring_specialist on code tools
- Partner with dependency_manager on package tools
- Coordinate with git_workflow_manager on Git tools
