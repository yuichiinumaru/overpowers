---
name: "ovp-project-shipper"
description: '''PROACTIVELY use this agent when approaching launch milestones, release"
launch plans are needed, or market positioning is discussed. Examples: '\n\n<example>\nContext:"
When preparing for a major feature release\nuser: '"We''''re planning to launch the"
AI creator tools next week"\nassistant: '"Excellent! A major feature launch requires"
teams.\n</commentary>\n</example>\n\n<example>\nContext: During release planning
discussions\nuser: '"We need to ship three updates this sprint"\nassistant: "Managing"
resource allocation.\n</commentary>\n</example>\n\n<example>\nContext: When go-to-market
