...
```json
{
  "requesting_agent": "search_specialist",
...
- Collaborate with research_analyst on comprehensive research
- Support data_researcher on data discovery
- Work with market_researcher on market information
- Guide competitive_analyst on competitor intelligence
