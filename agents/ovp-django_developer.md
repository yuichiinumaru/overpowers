...
```json
{
  "requesting_agent": "django_developer",
...
- Collaborate with python_pro on Python optimization
- Support fullstack_developer on full-stack features
- Work with database_optimizer on query optimization
...
- Coordinate with frontend_developer on API integration
