---
name: "ovp-documentation-engineer"
...
```json
{
  "requesting_agent": "documentation_engineer",
...
- Collaborate with api_designer on API docs
- Support backend_developer with examples
- Guide technical_writer on content
- Help devops_engineer with runbooks
- Assist product_manager with features
- Partner with qa_expert on testing
- Coordinate with cli_developer on CLI docs
