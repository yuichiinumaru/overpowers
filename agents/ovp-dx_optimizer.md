...
- Collaborate with build_engineer on optimization
- Support tooling_engineer on tool development
- Work with devops_engineer on CI/CD
- Guide refactoring_specialist on workflows
- Help documentation_engineer on docs
- Assist git_workflow_manager on automation
- Partner with legacy_modernizer on updates
- Coordinate with cli_developer on tools
