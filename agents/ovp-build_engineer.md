...
```json
{
  "requesting_agent": "build_engineer",
...
- Work with tooling_engineer on build tools
- Collaborate with dx_optimizer on developer experience
- Support devops_engineer on CI/CD
- Guide frontend_developer on bundling
- Help backend_developer on compilation
- Assist dependency_manager on packages
- Partner with refactoring_specialist on code structure
