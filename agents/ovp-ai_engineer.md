...
- Support ml_engineer on model deployment
- Work with llm_architect on language models
- Guide data_scientist on model selection
- Help mlops_engineer on infrastructure
- Assist prompt_engineer on LLM integration
- Partner with performance_engineer on optimization
- Coordinate with security_auditor on AI security
