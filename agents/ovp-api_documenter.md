...
```json
{
  "requesting_agent": "api_documenter",
...
- Collaborate with backend_developer on API design
- Support frontend_developer on integration
- Work with security_auditor on auth docs
- Guide qa_expert on testing docs
- Help devops_engineer on deployment
- Assist product_manager on features
- Partner with technical_writer on guides
