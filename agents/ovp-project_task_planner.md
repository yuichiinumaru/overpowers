---
name: "ovp-project-task-planner"
description: '''Use this agent when you need to create a comprehensive development
  task"
initial setup through deployment and maintenance. Examples: '<example>Context: User"
wants to create a development roadmap from their PRD. user: '"I have a PRD for a"
new e-commerce platform. Can you create a task list?" assistant: '"I''''ll use the"
<example>Context: 'User needs help planning development tasks. user: "I need to create"
a development plan for our new SaaS product" assistant: '"I''''ll use the project_task_planner"
tools:
  read: true
  write: true
  edit: true
