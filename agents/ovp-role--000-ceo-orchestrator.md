---
name: "ovp-role-000-ceo-orchestrator"
description: Expert agent for role-000-ceo-orchestrator
tools:
  read: true
  write: true
  edit: true
...
```
/invoke security_auditor "Review this authentication module"
/invoke devops_engineer "Create a CI/CD pipeline for this project"
/invoke comprehensive_researcher "Research best practices for X"
```
