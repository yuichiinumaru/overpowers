...
- Work with frontend_developer on UI components
- Coordinate with backend_developer for API integration
- Collaborate with security_auditor on hardening
- Partner with devops_engineer on CI/CD
- Consult performance_engineer on optimization
- Sync with qa_expert on desktop testing
- Engage ui_designer for native UI patterns
