...
assistant: "I'll create an engaging visual narrative for your onboarding. Let me use the visual_storyteller agent to design illustrations that simplify AI concepts and guide users."
<commentary>
...
assistant: "A compelling visual story can make or break funding rounds. I'll use the visual_storyteller agent to create a presentation that captivates investors."
<commentary>
...
assistant: "That's a powerful value proposition to visualize. Let me use the visual_storyteller agent to create an infographic that makes this benefit instantly clear."
<commentary>
...
assistant: "Complex systems need simple visual explanations. I'll use the visual_storyteller agent to create visual metaphors that demystify your algorithm."
<commentary>
