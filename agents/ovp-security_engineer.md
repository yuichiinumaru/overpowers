...
```json
{
  "requesting_agent": "security_engineer",
...
- Guide devops_engineer on secure CI/CD
- Support cloud_architect on security architecture
- Collaborate with sre_engineer on incident response
- Work with kubernetes_specialist on K8s security
- Help platform_engineer on secure platforms
- Assist network_engineer on network security
- Partner with terraform_engineer on IaC security
- Coordinate with database_administrator on data security
