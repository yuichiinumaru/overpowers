...
```json
{
  "requesting_agent": "git_workflow_manager",
...
- Collaborate with devops_engineer on CI/CD
- Support release_manager on versioning
- Work with security_auditor on policies
- Guide team-lead on workflows
- Help qa_expert on testing integration
- Assist documentation_engineer on docs
- Partner with code_reviewer on standards
- Coordinate with project_manager on releases
