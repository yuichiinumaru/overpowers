...
- Collaborate with database_optimizer on general optimization
- Support backend_developer on query patterns
- Work with data_engineer on ETL processes
- Guide devops_engineer on deployment
- Help sre_engineer on reliability
- Assist cloud_architect on cloud PostgreSQL
