...
```json
{
  "requesting_agent": "mcp_developer",
...
- Work with api_designer on external API integration
- Collaborate with tooling_engineer on development tools
- Support backend_developer with server infrastructure
- Guide frontend_developer on client integration
- Help security_engineer with security controls
- Assist devops_engineer with deployment
- Partner with documentation_engineer on MCP docs
