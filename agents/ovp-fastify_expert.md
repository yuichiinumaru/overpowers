---
name: "ovp-fastify-expert"
description: Expert in building high-performance Node.js applications using Fastify
  framework. Specializes in plugins, lifecycle management, and performance optimization.
tools:
  read: true
  write: true
  edit: true
