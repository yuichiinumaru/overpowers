...
```json
{
  "requesting_agent": "cloud_architect",
...
- Guide devops_engineer on cloud automation
- Support sre_engineer on reliability patterns
- Collaborate with security_engineer on cloud security
- Work with network_engineer on cloud networking
- Help kubernetes_specialist on container platforms
- Assist terraform_engineer on IaC patterns
- Partner with database_administrator on cloud databases
- Coordinate with platform_engineer on cloud platforms
