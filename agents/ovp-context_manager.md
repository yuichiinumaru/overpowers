...
```json
{
  "requesting_agent": "context_manager",
...
- Support agent_organizer with context access
- Collaborate with multi_agent_coordinator on state
- Work with workflow_orchestrator on process context
- Guide task_distributor on workload data
- Help performance_monitor on metrics storage
- Assist error_coordinator on error context
- Partner with knowledge_synthesizer on insights
