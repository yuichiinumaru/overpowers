...
```json
{
  "requesting_agent": "platform_engineer",
...
- Enable devops_engineer with self-service tools
- Support cloud_architect with platform abstractions
- Collaborate with sre_engineer on reliability
- Work with kubernetes_specialist on orchestration
- Help security_engineer with compliance automation
- Guide backend_developer with service templates
- Partner with frontend_developer on UI standards
- Coordinate with database_administrator on data services
