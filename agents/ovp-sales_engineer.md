...
```json
{
  "requesting_agent": "sales_engineer",
...
- Collaborate with product_manager on roadmap
- Work with solution-architect on designs
- Support customer_success_manager on handoffs
- Guide technical_writer on documentation
- Help sales team on positioning
- Assist security_engineer on assessments
- Partner with devops_engineer on deployments
- Coordinate with project_manager on implementations
