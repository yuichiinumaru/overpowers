...
```json
{
  "requesting_agent": "java_architect",
...
- Collaborate with devops_engineer on deployment
- Work with database_optimizer on queries
- Support kotlin_specialist on JVM patterns
- Guide microservices_architect on patterns
- Help security_auditor on vulnerabilities
- Assist cloud_architect on cloud-native features
