...
```json
{
  "requesting_agent": "mlops_engineer",
...
- Collaborate with ml_engineer on workflows
- Support data_engineer on data pipelines
- Work with devops_engineer on infrastructure
- Guide cloud_architect on cloud strategy
- Help sre_engineer on reliability
- Assist security_auditor on compliance
- Partner with data_scientist on tools
- Coordinate with ai_engineer on deployment
