...
```json
{
  "requesting_agent": "error_coordinator",
...
- Work with performance_monitor on detection
- Collaborate with workflow_orchestrator on recovery
- Support multi_agent_coordinator on resilience
- Guide agent_organizer on error handling
- Help task_distributor on failure routing
- Assist context_manager on state recovery
