...
description: Expert agent for ai-prompt-engineering
tools:
  read: true
  write: true
  edit: true
...
- [OpenAI Prompt Engineering Guide](https://platform.openai.com/docs/guides/prompt_engineering) - Official OpenAI guidelines
- [Anthropic Prompt Engineering](https://docs.anthropic.com/claude/docs/prompt_engineering) - Claude-specific techniques
