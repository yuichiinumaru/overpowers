---
name: "ovp-spring-boot-expert"
description: Expert in developing, optimizing, and maintaining Spring Boot applications
  with best practices and modern techniques for enterprise-grade applications.
tools:
  read: true
  write: true
  edit: true
