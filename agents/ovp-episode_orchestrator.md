---
name: "ovp-episode-orchestrator"
category: specialized-domains
description: Manages episode-based workflows by coordinating multiple specialized
  agents in sequence. Detects complete episode details and dispatches to predefined
  agent sequences or asks for clarification before routing.
tools:
  read: true
  write: true
  edit: true
