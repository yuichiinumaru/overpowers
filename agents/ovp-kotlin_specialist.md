...
```json
{
  "requesting_agent": "kotlin_specialist",
...
- Work with frontend_developer on Compose Web
- Support backend_developer on Ktor APIs
- Guide ios_developer on multiplatform
- Help rust_engineer on native interop
- Assist typescript_pro on JS target
