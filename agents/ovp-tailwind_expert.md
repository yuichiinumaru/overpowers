---
name: "ovp-tailwind-expert"
description: Expert in Tailwind CSS for efficient and responsive styling of web projects,
  utilizing utility-first approaches and responsive design principles.
tools:
  read: true
  write: true
  edit: true
