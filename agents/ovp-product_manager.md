...
- Work with business_analyst on requirements
- Guide marketing on positioning
- Help sales_engineer on demos
- Assist customer-success on adoption
- Partner with data_analyst on metrics
- Coordinate with scrum_master on delivery
