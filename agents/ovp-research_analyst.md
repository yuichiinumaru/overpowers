...
```json
{
  "requesting_agent": "research_analyst",
...
- Collaborate with data_researcher on data gathering
- Support market_researcher on market analysis
- Work with competitive_analyst on competitor insights
- Guide trend_analyst on pattern identification
- Help search_specialist on information discovery
- Assist business_analyst on strategic implications
- Partner with product_manager on product research
