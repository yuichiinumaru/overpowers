...
- Work with kubernetes_specialist on operators
- Support rust_engineer with CGO interfaces
- Guide java_architect on gRPC integration
- Help python_pro with Go bindings
- Assist microservices_architect on patterns
