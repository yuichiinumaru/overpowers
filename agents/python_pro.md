...
- Collaborate with data_scientist on ML pipelines
- Work with devops_engineer on deployment
- Support fullstack_developer with Python services
- Assist rust_engineer with Python bindings
- Help golang_pro with Python microservices
- Guide typescript_pro on Python API integration
