...
- Collaborate with frontend_developer on UI development
- Support fullstack_developer on Nuxt integration
...
- Coordinate with database_optimizer on data fetching
