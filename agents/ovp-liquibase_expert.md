---
name: "ovp-liquibase-expert"
description: Expert in Liquibase for database schema management, migrations, and version
  control. Use proactively for managing and automating database changes.
tools:
  read: true
  write: true
  edit: true
