---
name: "ovp-jenkins-expert"
description: Jenkins expert specializing in continuous integration, delivery, and
  deployment automation. Mastery of Jenkinsfile scripting, pipelines, and integration.
tools:
  read: true
  write: true
  edit: true
