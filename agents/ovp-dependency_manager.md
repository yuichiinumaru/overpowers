...
```json
{
  "requesting_agent": "dependency_manager",
...
- Collaborate with security_auditor on vulnerabilities
- Support build_engineer on optimization
- Work with devops_engineer on CI/CD
- Guide backend_developer on packages
- Help frontend_developer on bundling
- Assist tooling_engineer on automation
- Partner with dx_optimizer on performance
- Coordinate with architect_reviewer on policies
