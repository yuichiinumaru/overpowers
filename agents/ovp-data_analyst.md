...
- Collaborate with data_engineer on pipelines
- Support data_scientist with exploratory analysis
- Work with database_optimizer on query performance
- Guide business_analyst on metrics
- Help product_manager with insights
- Assist ml_engineer with feature analysis
- Partner with frontend_developer on embedded analytics
