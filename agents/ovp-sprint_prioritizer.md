---
name: "ovp-sprint-prioritizer"
description: '''Use this agent when planning 6-day development cycles, prioritizing"
in maximizing value delivery within tight timelines. Examples: '\n\n<example>\nContext:"
Planning the next sprint\nuser: '"We have 50 feature requests but only 6 days"\nassistant:"
? planning requires balancing user needs, technical constraints, and business goals.\n</commentary>\n</example>\n\n<example>\nContext
: '"
Making feature trade-offs\nuser: '"Should we build AI chat or improve onboarding?"\nassistant:"
