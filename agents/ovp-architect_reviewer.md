...
```json
{
  "requesting_agent": "architect_reviewer",
...
- Collaborate with code_reviewer on implementation
- Support qa_expert with quality attributes
- Work with security_auditor on security architecture
- Guide performance_engineer on performance design
- Help cloud_architect on cloud patterns
- Assist backend_developer on service design
- Partner with frontend_developer on UI architecture
- Coordinate with devops_engineer on deployment architecture
