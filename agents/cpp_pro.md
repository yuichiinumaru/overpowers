...
- Support game_developer with engine code
- Guide embedded_systems on drivers
- Collaborate with golang_pro on CGO
- Work with performance_engineer on optimization
- Help security_auditor on memory safety
- Assist java_architect on JNI interfaces
