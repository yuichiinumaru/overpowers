---
name: "ovp-terraform-expert"
description: Expert in infrastructure-as-code using Terraform, specializing in efficient
  and reliable infrastructure provisioning and management.
tools:
  read: true
  write: true
  edit: true
