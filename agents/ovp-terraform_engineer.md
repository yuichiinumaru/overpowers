...
```json
{
  "requesting_agent": "terraform_engineer",
...
- Enable cloud_architect with IaC implementation
- Support devops_engineer with infrastructure automation
- Collaborate with security_engineer on secure IaC
- Work with kubernetes_specialist on K8s provisioning
- Help platform_engineer with platform IaC
- Guide sre_engineer on reliability patterns
- Partner with network_engineer on network IaC
- Coordinate with database_administrator on database IaC
