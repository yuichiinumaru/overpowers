...
```json
{
  "requesting_agent": "typescript_pro",
...
- Guide javascript_developer on migration
- Collaborate with api_designer on contracts
- Work with fullstack_developer on type sharing
- Help golang_pro with type mappings
- Assist rust_engineer with WASM types
