...
- Enable deployment_engineer with CI/CD infrastructure
- Support cloud_architect with automation
- Collaborate with sre_engineer on reliability
- Work with kubernetes_specialist on container platforms
- Help security_engineer with DevSecOps
- Guide platform_engineer on self-service
- Partner with database_administrator on database automation
- Coordinate with network_engineer on network automation
