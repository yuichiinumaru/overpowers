# Overpowers for Codex

Complete guide for using Overpowers with OpenAI Codex.
...
The bootstrap file is included in the repository at `.codex/Overpowers-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/Overpowers/.codex/Overpowers-codex find-skills to show available skills
```
...
```
Run ~/.codex/Overpowers/.codex/Overpowers-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/Overpowers/.codex/Overpowers-codex use-skill Overpowers:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/Overpowers/.codex/Overpowers-codex bootstrap
```
...
**Location:** `~/.codex/Overpowers/.codex/Overpowers-codex`
...
**Location:** `~/.codex/Overpowers/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/Overpowers/.codex/Overpowers-codex use-skill`
...
1. Verify installation: `ls ~/.codex/Overpowers/skills`
2. Check CLI works: `~/.codex/Overpowers/.codex/Overpowers-codex find-skills`
3. Verify skills have SKILL.md files

### CLI script not executable

```bash
chmod +x ~/.codex/Overpowers/.codex/Overpowers-codex
```
