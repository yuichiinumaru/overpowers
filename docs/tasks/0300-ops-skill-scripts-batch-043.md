...
## Sub-tasks
- [ ] `sci-sci-0879-sci-sci-0293-d3-viz`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0879-sci-sci-0293-d3-viz`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0880-sci-sci-0308-data-scientist`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0880-sci-sci-0308-data-scientist`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0881-sci-sci-0383-evaluating-llms-harness`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0881-sci-sci-0383-evaluating-llms-harness`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0882-sci-sci-0402-fact-checker`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0882-sci-sci-0402-fact-checker`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0883-sci-sci-0435-fluidsim`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0883-sci-sci-0435-fluidsim`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0884-sci-sci-0474-get-review-theme`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0884-sci-sci-0474-get-review-theme`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0885-sci-sci-0542-hypothesis-generation`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0885-sci-sci-0542-hypothesis-generation`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0886-sci-sci-0637-marketing-psychology`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0886-sci-sci-0637-marketing-psychology`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0887-sci-sci-0677-ml-paper-writing`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
- [ ] `sci-sci-0887-sci-sci-0677-ml-paper-writing`: Analyze and create new helper scripts inside its `scripts/` directory (if applicable)
- [ ] `sci-sci-0888-sci-sci-0683-moltbook-search`: Check if any existing script inside the repository's `scripts/` subfolders would fit as a helper and copy it over (if applicable)
