...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh list

# Connect to a site
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh connect example.com

# Upload files to a site
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh upload example.com /local/path /remote/path

# Download files from a site
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh download example.com /remote/path /local/path

# Execute command on server
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'ls -la'
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh upload example.com ./dist/ /domains/example.com/public_html/

# Backup website
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh download example.com /domains/example.com/public_html/ ./backup/

# Update specific files
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh upload example.com ./index.html /domains/example.com/public_html/index.html
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'mysql -u username -p database_name'

# Backup database
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'mysqldump -u username -p database_name > backup.sql'
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'chmod 644 /domains/example.com/public_html/*.html'
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'chmod 755 /domains/example.com/public_html/scripts/'
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'ls -la /domains/example.com/'

# Verify disk space
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'df -h'

# Check file permissions
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'ls -la /domains/example.com/public_html/'
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'echo "gzip on;" >> /domains/example.com/.htaccess'

# Optimize images before upload
# Use tools like imagemin or tinypng before uploading

# Monitor resource usage
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'top'
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh exec example.com 'df -h'
```
...
./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh download example.com /domains/example.com/public_html/ ./backups/example.com_$DATE/
```
