...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh check-availability personal example.com

# Bulk check multiple domains
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh bulk-check personal example.com example.net example.org

# Check with pricing information
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh check-availability personal premium-domain.com
```
...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal mynewdomain.com 1 true

# Purchase domain for multiple years
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal longterm-project.com 3 true

# Purchase without auto-renewal
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal temporary-project.com 1 false
```
...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh domains personal

# Get domain details including expiration
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh domain-details personal mydomain.com

# Monitor domains expiring soon
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh monitor-expiration personal 30
```
...
$ ./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal newproject.com 1 true
...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh bulk-check personal \
  myproject.com myproject.net myproject.org \
  myproject.io myproject.app myproject.dev

# Check premium domain pricing
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh check-availability personal premium-name.com
```
...
./.agent/skills/aws-mcp-setup/scripts/setup-wizard-helper.sh assess
...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh monitor-expiration personal 60

# Audit domain configuration
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh audit personal mydomain.com
```
...
for domain in $(./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh domains personal | awk '{print $1}'); do
    echo "Analyzing costs for: $domain"
    ./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh domain-details personal $domain | grep -E "(price|renewal|expiration)"
done
```
...
1. Domain research and purchase:
   ./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh bulk-check personal myproject.com myproject.dev
   ./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal myproject.com 1 true

2. DNS configuration:
   ./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal myproject.com @ A 192.168.1.100
   ./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal myproject.com www CNAME myproject.com

3. SSL certificate setup:
   # Automatic with Cloudflare or manual certificate installation

4. Project deployment:
   ./.agent/skills/coolify-integration/scripts/coolify-helper.sh deploy production myproject myproject.com
```
...
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal myproject.com 1 true      # Production
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal myproject.dev 1 true     # Development
./.agent/skills/spaceship-integration/scripts/spaceship-helper.sh purchase personal myproject.app 1 true     # Mobile app

# Configure DNS for each environment
./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal myproject.com @ A 192.168.1.100
./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal myproject.dev @ A 192.168.1.101
./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal myproject.app @ A 192.168.1.102
```
