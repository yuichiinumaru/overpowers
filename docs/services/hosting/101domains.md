...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh accounts

# List domains for account
./.agent/skills/101domains-integration/scripts/101domains-helper.sh domains personal

# Get domain details
./.agent/skills/101domains-integration/scripts/101domains-helper.sh domain-details personal example.com

# Audit complete domain configuration
./.agent/skills/101domains-integration/scripts/101domains-helper.sh audit personal example.com
```
...
```bash
# List DNS records
./.agent/skills/101domains-integration/scripts/101domains-helper.sh dns-records personal example.com

# Add DNS record
./.agent/skills/101domains-integration/scripts/101domains-helper.sh add-dns personal example.com www A 192.168.1.100 3600

# Update DNS record
./.agent/skills/101domains-integration/scripts/101domains-helper.sh update-dns personal example.com record-id www A 192.168.1.101 3600

# Delete DNS record
./.agent/skills/101domains-integration/scripts/101domains-helper.sh delete-dns personal example.com record-id
```
...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh nameservers personal example.com

# Update to Cloudflare nameservers
./.agent/skills/101domains-integration/scripts/101domains-helper.sh update-ns personal example.com ns1.cloudflare.com ns2.cloudflare.com

# Update to Route 53 nameservers
./.agent/skills/101domains-integration/scripts/101domains-helper.sh update-ns personal example.com ns-1.awsdns-01.com ns-2.awsdns-02.net ns-3.awsdns-03.org ns-4.awsdns-04.co.uk
```
...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh check-availability personal newdomain.com

# Get domain contacts
./.agent/skills/101domains-integration/scripts/101domains-helper.sh contacts personal example.com

# Lock domain
./.agent/skills/101domains-integration/scripts/101domains-helper.sh lock personal example.com

# Unlock domain
./.agent/skills/101domains-integration/scripts/101domains-helper.sh unlock personal example.com

# Check transfer status
./.agent/skills/101domains-integration/scripts/101domains-helper.sh transfer-status personal example.com
```
...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh privacy-status personal example.com

# Enable domain privacy
./.agent/skills/101domains-integration/scripts/101domains-helper.sh enable-privacy personal example.com

# Disable domain privacy
./.agent/skills/101domains-integration/scripts/101domains-helper.sh disable-privacy personal example.com
```
...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh monitor-expiration personal 30

# Monitor domain expiration (60 days warning)
./.agent/skills/101domains-integration/scripts/101domains-helper.sh monitor-expiration personal 60
...
for domain in example.com another.com; do
    ./.agent/skills/101domains-integration/scripts/101domains-helper.sh audit personal $domain
done
```
...
for domain in $(./.agent/skills/101domains-integration/scripts/101domains-helper.sh domains personal | awk '{print $1}'); do
    echo "Privacy status for $domain:"
    ./.agent/skills/101domains-integration/scripts/101domains-helper.sh privacy-status personal $domain
done
```
...
./.agent/skills/101domains-integration/scripts/101domains-helper.sh monitor-expiration $ACCOUNT $THRESHOLD

# Check privacy settings
echo "=== PRIVACY AUDIT ==="
for domain in $(./.agent/skills/101domains-integration/scripts/101domains-helper.sh domains $ACCOUNT | awk '{print $1}'); do
    privacy_status=$(./.agent/skills/101domains-integration/scripts/101domains-helper.sh privacy-status $ACCOUNT $domain)
...
```bash
# Backup DNS records
./.agent/skills/101domains-integration/scripts/101domains-helper.sh dns-records personal example.com > dns-backup-example.com-$(date +%Y%m%d).txt

# Backup domain configuration
./.agent/skills/101domains-integration/scripts/101domains-helper.sh audit personal example.com > domain-audit-example.com-$(date +%Y%m%d).txt

# Backup privacy settings
./.agent/skills/101domains-integration/scripts/101domains-helper.sh privacy-status personal example.com > privacy-backup-example.com-$(date +%Y%m%d).txt
```
...
# Backup all domains
for domain in $(./.agent/skills/101domains-integration/scripts/101domains-helper.sh domains personal | awk '{print $1}'); do
    ./.agent/skills/101domains-integration/scripts/101domains-helper.sh audit personal $domain > "backup-$domain-$(date +%Y%m%d).txt"
done
```
