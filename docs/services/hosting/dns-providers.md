...
./.agent/skills/dns-integration/scripts/dns-helper.sh records cloudflare personal example.com
./.agent/skills/dns-integration/scripts/dns-helper.sh records namecheap personal example.com
./.agent/skills/dns-integration/scripts/dns-helper.sh records route53 production example.com

# Add DNS records
./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal example.com www A 192.168.1.100
./.agent/skills/dns-integration/scripts/dns-helper.sh add namecheap personal example.com mail A 192.168.1.101
./.agent/skills/dns-integration/scripts/dns-helper.sh add route53 production example.com api A 192.168.1.102

# Update DNS records
./.agent/skills/dns-integration/scripts/dns-helper.sh update cloudflare personal example.com record-id www A 192.168.1.200

# Delete DNS records
./.agent/skills/dns-integration/scripts/dns-helper.sh delete cloudflare personal example.com record-id
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh proxy-enable cloudflare personal example.com record-id

# Configure page rules
./.agent/skills/dns-integration/scripts/dns-helper.sh page-rule cloudflare personal example.com "*.example.com/*" cache-everything

# Get analytics
./.agent/skills/dns-integration/scripts/dns-helper.sh analytics cloudflare personal example.com
```
...
```bash
# Create health check
./.agent/skills/dns-integration/scripts/dns-helper.sh health-check route53 production example.com https://example.com/health

# Configure weighted routing
./.agent/skills/dns-integration/scripts/dns-helper.sh weighted-routing route53 production example.com www A 192.168.1.100 50

# Set up geolocation routing
./.agent/skills/dns-integration/scripts/dns-helper.sh geo-routing route53 production example.com www A 192.168.1.100 US
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh enable-dnssec cloudflare personal example.com

# Configure CAA records
./.agent/skills/dns-integration/scripts/dns-helper.sh add cloudflare personal example.com @ CAA "0 issue letsencrypt.org"

# Set up monitoring
./.agent/skills/dns-integration/scripts/dns-helper.sh monitor cloudflare personal example.com
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh propagation-check example.com

# Check TTL values
./.agent/skills/dns-integration/scripts/dns-helper.sh ttl-check example.com
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh test-auth cloudflare personal
./.agent/skills/dns-integration/scripts/dns-helper.sh test-auth namecheap personal
./.agent/skills/dns-integration/scripts/dns-helper.sh test-auth route53 production

# Verify API permissions
./.agent/skills/dns-integration/scripts/dns-helper.sh check-permissions cloudflare personal
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh conflict-check cloudflare personal example.com

# Validate DNS configuration
./.agent/skills/dns-integration/scripts/dns-helper.sh validate cloudflare personal example.com

# Compare configurations across providers
./.agent/skills/dns-integration/scripts/dns-helper.sh compare example.com cloudflare:personal namecheap:personal
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh monitor-resolution example.com

# Check DNS performance
./.agent/skills/dns-integration/scripts/dns-helper.sh performance-check example.com

# Monitor DNS changes
./.agent/skills/dns-integration/scripts/dns-helper.sh change-log cloudflare personal example.com
```
...
# Generate DNS report
./.agent/skills/dns-integration/scripts/dns-helper.sh report cloudflare personal example.com

# Export DNS configuration
./.agent/skills/dns-integration/scripts/dns-helper.sh export cloudflare personal example.com > dns-backup.json
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh export namecheap personal example.com > source-dns.json

# Import DNS records to destination
./.agent/skills/dns-integration/scripts/dns-helper.sh import cloudflare personal example.com source-dns.json

# Verify migration
./.agent/skills/dns-integration/scripts/dns-helper.sh compare example.com namecheap:personal cloudflare:personal
```
...
./.agent/skills/dns-integration/scripts/dns-helper.sh backup cloudflare personal example.com

# Restore DNS configuration
./.agent/skills/dns-integration/scripts/dns-helper.sh restore cloudflare personal example.com backup-file.json

# Schedule automated backups
./.agent/skills/dns-integration/scripts/dns-helper.sh schedule-backup cloudflare personal daily
```
