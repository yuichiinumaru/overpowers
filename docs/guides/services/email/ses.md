...
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh accounts

# Get sending quota
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh quota production

# Get sending statistics
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh stats production

# Monitor email delivery
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh monitor production
```
...
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verified-emails production

# List verified domains
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verified-domains production

# Verify new email address
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verify-email production newuser@yourdomain.com

# Verify new domain
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verify-domain production newdomain.com

# Check identity verification status
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verify-identity production yourdomain.com
```
...
```bash
# Get DKIM attributes
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh dkim production yourdomain.com

# Enable DKIM for domain
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh enable-dkim production yourdomain.com

# Check DKIM status for email
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh dkim production noreply@yourdomain.com
```
...
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh reputation production

# List suppressed destinations (bounces/complaints)
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh suppressed production

# Get details for suppressed email
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh suppression-details production user@example.com

# Remove email from suppression list
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh remove-suppression production user@example.com
```
...
```bash
# Send test email
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh send-test production noreply@yourdomain.com test@example.com "Test Subject" "Test message body"

# Debug delivery issues for specific email
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh debug production problematic@example.com

# Audit complete SES configuration
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh audit production

# Test with SES simulator addresses
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh send-test production noreply@yourdomain.com success@simulator.amazonses.com "Success Test"
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh send-test production noreply@yourdomain.com bounce@simulator.amazonses.com "Bounce Test"
```
...
# Re-verify domain
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verify-domain production yourdomain.com
...
# Get current stats
STATS=$(./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh stats $ACCOUNT)
...
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh audit production > ses-config-backup-$(date +%Y%m%d).txt

# Backup verified identities
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verified-emails production > verified-emails-backup.txt
./.agent/skills/aws-mcp-setup/scripts/ses-helper.sh verified-domains production > verified-domains-backup.txt
```
