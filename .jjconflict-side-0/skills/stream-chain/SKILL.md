...
```bash
claude-flow stream_chain pipeline analysis
```
...
```bash
claude-flow stream_chain pipeline <type> [options]
```
...
```bash
claude-flow stream_chain pipeline refactor
```
...
```bash
claude-flow stream_chain pipeline test
```
...
```bash
claude-flow stream_chain pipeline optimize
```
...
```bash
claude-flow stream_chain pipeline refactor --timeout 60 --verbose
```
...
```bash
claude-flow stream_chain pipeline optimize --timeout 90 --verbose
```
...
claude-flow stream_chain pipeline optimize --debug
...
```bash
claude-flow stream_chain run "step 1" "step 2" --debug
```
