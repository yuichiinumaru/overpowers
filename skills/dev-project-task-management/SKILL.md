---
name: dev-project-task-management
description: Software development project task management with strict versioning and archiving disciplines.
tags: [development, project-management, versioning, archiving, workflow]
version: 1.0.0
---
