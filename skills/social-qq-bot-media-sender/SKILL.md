---
name: social-qq-bot-media-sender
version: 1.0.0
description: Send images, videos, and files to QQ via bot. Supports batch sending, automatic compression, and various file formats including JPG, PNG, GIF, MP4, PDF, and more.
tags: [qq, bot, media, social, communication]
category: social
---

# QQBot Media Sender

一键发送图片、视频、文件到 QQ 聊天窗口，支持批量发送 and 自动压缩。
