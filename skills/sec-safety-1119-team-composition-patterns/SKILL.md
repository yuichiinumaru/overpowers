...
This skill includes a script to generate preset team configurations:

- **scripts/team_preset_gen.py**: Generates a JSON configuration for common team presets (review, debug, feature, fullstack).

Usage:
```bash
# Generate fullstack team configuration
python3 scripts/team_preset_gen.py fullstack
```
