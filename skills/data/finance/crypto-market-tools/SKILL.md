---
name: growth-biz-crypto-market-tools
description: "Cryptocurrency market data and price alert monitoring tool based on CCXT. Supports multiple exchanges (Binance, OKX, etc.), real-time price tracking, and configurable alerts."
tags:
  - crypto
  - market-data
  - ccxt
...
基于 CCXT 库的加密货币行情获取 e 价格监控预警工具，支持多交易所、实时监控 e 智能预警。
