---
name: infra-ops-zentao-automation
description: ZenTao (禅道) MCP expansion pack for project management, task generation, effort logging, and state machine control.
version: 1.0.0
tags: [zentao, project-management, mcp, task-automation]
---
