        ...
        case "$command" in
            "connect"|"ssh"|"")
                if [[ "$auth_type" == "hostinger" ]]; then
                    ...
                    ./.agent/skills/closte-integration/scripts/closte-helper.sh list
                elif [[ "$auth_type" == "cloudron" ]]; then
                    print_info "Use Cloudron helper for server management..."
                    ./.agent/skills/cloudron-integration/scripts/cloudron-helper.sh list
                elif [[ "$auth_type" == "dns" ]]; then
                    print_info "Use DNS helper for domain management..."
                    ./.agent/skills/dns-integration/scripts/dns-helper.sh list
                elif [[ "$auth_type" == "localhost" ]]; then
                    print_info "Use Localhost helper for local development..."
                    ./.agent/skills/localhost-integration/scripts/localhost-helper.sh list
                    ...
                    ./.agent/skills/github-release-management/scripts/github-cli-helper.sh list-accounts
                    ...
                    ./.agent/skills/gitea-cli-integration/scripts/gitea-cli-helper.sh list-accounts
                fi
                ;;
            *)
    ...
    *)
        ...
        case "$command" in
            ...
            "help"|"-h"|"--help")
                ...
                echo "  ./.agent/skills/hostinger-integration/scripts/hostinger-helper.sh      - Hostinger shared hosting"
                echo "  ./.agent/skills/hetzner-integration/scripts/hetzner-helper.sh        - Hetzner Cloud VPS"
                echo "  ./.agent/skills/closte-integration/scripts/closte-helper.sh         - Closte.com VPS servers"
                echo "  ./.agent/skills/cloudron-integration/scripts/cloudron-helper.sh       - Cloudron server management"
                echo "  ./.agent/skills/dns-integration/scripts/dns-helper.sh            - DNS management across providers"
                echo "  ./.agent/skills/localhost-integration/scripts/localhost-helper.sh      - Local development with .local domains"
                echo "  ./.agent/scripts/aws-helper.sh            - AWS EC2 instances"
                echo "  ./.agent/skills/github-release-management/scripts/github-cli-helper.sh     - GitHub CLI repository management"
                echo "  ./.agent/skills/gitlab-ci-patterns/scripts/gitlab-cli-helper.sh     - GitLab CLI project management"
                echo "  ./.agent/skills/gitea-cli-integration/scripts/gitea-cli-helper.sh      - Gitea CLI repository management"
                ;;
            *)
