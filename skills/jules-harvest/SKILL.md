...
digraph when_to_use {
    ...
    "jules-harvest" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Branches exist on remote?" -> "jules-harvest" [label="yes"];
...
## Status
🟡 **Pending Triage** - Ready for jules-triage analysis
```
...
Create `scripts/jules-harvest.sh`:
...
echo ""
echo "✅ Harvest complete! Run jules-triage to analyze."
```
