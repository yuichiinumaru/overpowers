...
This skill includes several helper scripts to facilitate integration and testing:

- **scripts/webhook_simulator.py**: Simulates Stripe webhook events for local testing.
- **scripts/list_recent_events.py**: Fetches and displays recent Stripe events from your account.

Usage:
```bash
# Simulate a successful payment webhook
python3 scripts/webhook_simulator.py http://localhost:5000/webhook --type payment_intent.succeeded --secret whsec_...

# List recent events
export STRIPE_SECRET_KEY="sk_test_..."
python3 scripts/list_recent_events.py --limit 5
```
