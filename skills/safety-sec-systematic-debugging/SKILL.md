...
This skill includes scripts to enforce the systematic process:

- **scripts/debug_session_init.sh**: Initializes a `DEBUG_LOG.md` to track your progress through the 4 phases.
- **scripts/reproduction_stub.py**: A Python boilerplate for creating consistent reproduction scripts.

Usage:
```bash
# Start a new debug log
./scripts/debug_session_init.sh

# Use the stub to create a repro script
cp scripts/reproduction_stub.py reproduce_issue_123.py
# (edit reproduce_issue_123.py with your logic)
```
