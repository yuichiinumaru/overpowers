...
show_help() {
    ...
    echo "  $0 setup"
    echo "  $0 chat"
    echo "  $0 explain .agent/skills/infrastructure/scripts/hostinger-helper.sh"
    echo "  $0 refactor .agent/skills/code-auditor/scripts/quality-check.sh"
    echo "  $0 test .agent/skills/auth-setup/scripts/setup-wizard-helper.sh bash"
    echo "  $0 review"
    echo ""
    echo "Setup:"
