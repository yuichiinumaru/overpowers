...
description: Quantum-resistant, self-learning version control for AI agents with ReasoningBank
...
```javascript
const { JjWrapper } = require('agentic_jujutsu');
...
```javascript
const { generateQuantumFingerprint, verifyQuantumFingerprint } = require('agentic_jujutsu');
...
- **NPM Package**: https://npmjs.com/package/agentic_jujutsu
- **GitHub**: https://github.com/ruvnet/agentic-flow/tree/main/packages/agentic_jujutsu
