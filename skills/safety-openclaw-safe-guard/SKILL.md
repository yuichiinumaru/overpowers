---
name: safety-openclaw-safe-guard
description: 对 OpenClaw 系统及 Skills 进行静态安全扫描，检测权限风险、恶意代码和依赖风险
tags: [security, openclaw, safety, audit]
version: 1.0.0
---
...
4. **仅静态分析**：不执行被扫描的技能代码，仅读取 and 分析源码
