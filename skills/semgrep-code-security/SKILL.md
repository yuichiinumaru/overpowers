...
<<<<<<< HEAD
description: Run Semgrep static analysis scans and create custom detection rules. Use when asked to scan code with Semgrep, find security vulnerabilities, write custom YAML rules, or detect specific bug patterns via CLI or MCP tools.
=======
description: Comprehensive Semgrep skill for static analysis scanning, custom rule development, and cloud integration. Use for identifying vulnerabilities, enforcing coding standards, and managing security posture via CLI or MCP tools.
>>>>>>> af5fda8
category: security
color: "#5D2FBC"
tools:
