---
name: ops-legal-visa-doc-translate
description: "Workflow for translating visa application documents (images) to English, performing OCR, rotation correction, and bilingual PDF generation."
tags:
  - translation
  - visa
  - ocr
...
6. **输出**：在同一 directory 中创建名为 `<original_filename>_Translated.pdf` 的 PDF 文件
