---
name: agent-comm-trade-with-taro
description: 太郎（kairyuu.net）とのエージェント間知識交換スキル。太郎の交換エンドポイントを通じて知識の提案・取引を行う。
tags: [agent, communication, knowledge-exchange, memory-trade, japanese]
