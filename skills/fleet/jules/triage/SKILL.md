...
digraph when_to_use {
    ...
    "jules_triage" [shape=box style=filled fillcolor=lightgreen];
    "Run jules_harvest first" [shape=box];
    "Manual review" [shape=box];

    "Branches harvested?" -> "Multiple branches?" [label="yes"];
    "Branches harvested?" -> "Run jules_harvest first" [label="no"];
    "Multiple branches?" -> "jules_triage" [label="yes (3+)"];
...
|---------------|-------|--------|
| ✅ MERGE | 3 | Ready for jules_integrate |
...
| Skill | When to use |
|-------|-------------|
| [dispatch](../dispatch/) | Prepare and dispatch tasks to Jules |
| [harvest](../harvest/) | Fetch completed branches for analysis |
| [integrate](../integrate/) | Selectively merge approved branches |

**Uses:** parallel-agent dispatching or swarm plugin for concurrent branch analysis
