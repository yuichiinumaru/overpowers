...
digraph when_to_use {
    ...
    "jules_integrate" [shape=box style=filled fillcolor=lightgreen];
    "Run jules_triage first" [shape=box];
    "Nothing to integrate" [shape=box];

    "Triage complete?" -> "Has MERGE/ADAPT items?" [label="yes"];
    "Triage complete?" -> "Run jules_triage first" [label="no"];
    "Has MERGE/ADAPT items?" -> "jules_integrate" [label="yes"];
...
| [triage](../triage/) | Analyze branches and produce integration plan |

**Script:** `scripts/jj-jules-apply.sh` — safely applies a diff via Jujutsu
