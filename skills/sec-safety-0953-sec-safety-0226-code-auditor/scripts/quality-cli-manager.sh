...
# CLI Scripts
readonly CODERABBIT_SCRIPT=".agent/skills/code-auditor/scripts/coderabbit-cli.sh"
readonly CODACY_SCRIPT=".agent/skills/code-auditor/scripts/codacy-cli.sh"
readonly SONAR_SCRIPT=".agent/skills/sast-configuration/scripts/sonarscanner-cli.sh"
readonly SNYK_SCRIPT=".agent/skills/sast-configuration/scripts/snyk-helper.sh"
