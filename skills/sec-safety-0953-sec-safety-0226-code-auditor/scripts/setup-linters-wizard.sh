...
install_selected_linters() {
    ...
    print_info "- Run analysis: bash .agent/skills/code-auditor/scripts/quality-cli-manager.sh analyze all"
    print_info "- Auto-fix issues: bash .agent/skills/code-auditor/scripts/codacy-cli.sh analyze --fix"
    print_info "- Universal formatting: bash .agent/skills/code-auditor/scripts/qlty-cli.sh fmt --all"
    print_info "- Install additional linters: bash .agent/skills/code-auditor/scripts/linter-manager.sh install LANGUAGE"
    echo ""
