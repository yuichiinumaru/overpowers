...
def main():
    parser = argparse.ArgumentParser(description="Qwen Image Edit Multi Angle Helper Script")
    parser.add_argument("--action", help="The action to perform", default="analyze")
    args = parser.parse_args()

    print("======================================")
    print(f" Starting Qwen Image Edit Multi Angle Operation: {args.action}")
    print("======================================")
