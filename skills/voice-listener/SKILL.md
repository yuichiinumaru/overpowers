---
name: voice-listener
description: "百度语音识别 + 智能唤醒技能。支持'小龙虾'激活、'停止'暂停的持续监听模式，无需每次都说唤醒词。"
tags: ["voice", "speech-recognition", "baidu", "listener", "input"]
version: "1.0.0"
---
...
**错误：** 无法获取百度 Access Token

**解决：**
1. 检查 `baidu_config.json` 中的密钥是否正确
2. 检查网络连接
3. 重新登录百度控制台，检查 API 密钥状态
