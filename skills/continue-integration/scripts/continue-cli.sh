...
show_help() {
    ...
    echo "  $0 setup"
    echo "  $0 chat"
    echo "  $0 explain .agent/skills/hostinger-integration/scripts/hostinger-helper.sh"
    echo "  $0 refactor .agent/scripts/quality-check.sh"
    echo "  $0 test .agent/skills/aws-mcp-setup/scripts/setup-wizard-helper.sh bash"
    echo "  $0 review"
    echo ""
    echo "Setup:"
