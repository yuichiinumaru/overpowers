---
name: ai-swarm-smith-matrix
description: A recursive self-similar multi-agent system that decomposes tasks into conflict-free parallel sub-tasks using strict directory isolation.
tags: [ai, swarm, multi-agent, parallel-processing, recursive-decomposition]
version: 1.0.0
---
...
- [协议规范](./references/protocol.md) —— 详细的通信协议 and 约束规则
