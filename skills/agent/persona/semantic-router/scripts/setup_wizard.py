...
def step2_suggest_pools(task_types, available_models):
    ...
    model_recommendations = {
        ...
        "Humanities": ["custom-llmapi-lovbrowser-com/google/gemini-3.1-pro-preview", "custom-llmapi-lovbrowser-com/openai/gpt-4o", "custom-llmapi-lovbrowser-com/anthropic/claude-sonnet-4.6"],
