...
test_python_helper_script() {
    ...
    local helper_script="${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh"
...
1. Run full installation: \`bash .agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh setup\`
