...
test_helper_script() {
    ...
    local helper_script="${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-helper.sh"
...
1. Run full installation: \`bash .agent/skills/stagehand-integration/scripts/stagehand-helper.sh setup\`
