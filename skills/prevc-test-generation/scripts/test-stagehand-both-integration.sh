...
test_helper_consistency() {
    ...
    local js_helper="${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-helper.sh"
    local python_helper="${SCRIPT_DIR}/../../.agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh"
...
### JavaScript Setup
1. Run: \`bash .agent/skills/stagehand-integration/scripts/stagehand-helper.sh setup\`
2. Test: \`bash .agent/scripts/setup-mcp-integrations.sh stagehand\`

### Python Setup
1. Run: \`bash .agent/skills/stagehand-integration/scripts/stagehand-python-helper.sh setup\`
