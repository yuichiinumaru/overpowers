---
name: blueprint-security-audit
description: Proactive 4-phase security audit covering OWASP top 10, dependency vulnerabilities, secrets detection, and input validation with severity classification
tags:
  - security
  - audit
  - owasp
...
# Security Audit (Blueprint Edition)

One-paragraph summary: Systematic 4-phase security review (SCAN → ANALYZE → CLASSIFY → RECOMMEND) covering OWASP Top 10, dependency vulnerabilities, hardcoded secrets, dangerous code patterns, and authentication review. Produces a structured report with severity classification and prioritized remediations.

## When to Use

- Security review of a codebase or module
...
Search for hardcoded secrets using grep/search tools:
...
| A02 | Cryptographic Failures | TLS, proper password hashing (bcrypt/argon2), no weak hashing |
