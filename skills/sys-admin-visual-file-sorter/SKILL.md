---
name: sys-admin-visual-file-sorter
description: Automatically organizes Downloads and Desktop folders by "opening" files, using vision models to understand their content, renaming them intelligently, and archiving them into categorized directories.
tags: [file-organization, vision, automation, cleanup]
version: 1.0.0
---
