...
- Read memories, docs and knowledge folders — to acquire critical project context.
...
- Save all reports and logs to `.agents/reports/` using per-task filenames (e.g., `foreman-NNN-taskname`). See JOURNAL section below.
⚠️ **Ask first:**
